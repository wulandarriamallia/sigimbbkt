            ...
            @foreach ($imbPemohons as $imbPemohon)
              <tr>
                ...
                <td class="text-center">
                  <a class="btn btn-primary btn-sm" href="{!! route('front_office::imbPemohon.show', $imbPemohon->id) !!}" data-toggle="tooltip" data-placement="top" title="Detail {!! \sigimbbkt\Libraries\StringMod::upperCaseFirstChar($imbPemohon->nama) !!}"> <i class="icon-list icon"></i></a>
                </td>
              </tr>
            @endforeach
            </tbody>
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-primary" role="document">
    <div class="modal-content">
      ...
      <form role="form" method="POST" class="form-horizontal" action="{!! route('front_office::imbPemohon.store') !!}">
