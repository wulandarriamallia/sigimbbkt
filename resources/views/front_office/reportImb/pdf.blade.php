...
<body>
  <div class="header" style="width: 60%; margin: 0 auto">
    <img src="{!! asset('/assets/img/logo_bukittinggi.png') !!}" alt="logo_bukittinggi">
    <h4 align="center" style="margin: 0">{!! $rep['title'] !!}<br/>{!! $rep['subtitle'] !!}</h4>
  </div><br /><br /><br />
