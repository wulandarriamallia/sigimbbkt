...
<li class="breadcrumb-item"><a href="{!! route('front_office::report.imb') !!}">IMB</a></li>
  ...
  <div class="modal-dialog modal-lg modal-info" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="{!! url('/', null, false) !!}/front_office/report/imb/{!! $tahun !!}/a4" class="btn btn-primary btn-ladda ladda-button" data-color="blue" data-style="slide-left" target="_blank"><i class="fa fa-file-pdf-o" title="Kertas A4"> A4</i></a>
        <a href="{!! url('/', null, false) !!}/front_office/report/imb/{!! $tahun !!}/f4" class="btn btn-primary btn-ladda ladda-button" data-color="blue" data-style="slide-left" target="_blank"><i class="fa fa-file-pdf-o" title="Kertas F4"> F4</i></a>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
