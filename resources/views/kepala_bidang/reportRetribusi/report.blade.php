  ...
  <div class="modal-dialog modal-lg modal-info" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="{!! url('/', null, false) !!}/kepala_bidang/report/retribusi/{!! $rImbRetribusi->id !!}/a4" class="btn btn-primary btn-ladda ladda-button" data-color="blue" data-style="slide-left" target="_blank"><i class="fa fa-file-pdf-o" title="Kertas A4"> A4</i></a>
        <a href="{!! url('/', null, false) !!}/kepala_bidang/report/retribusi/{!! $rImbRetribusi->id !!}/f4" class="btn btn-primary btn-ladda ladda-button" data-color="blue" data-style="slide-left" target="_blank"><i class="fa fa-file-pdf-o" title="Kertas F4"> F4</i></a>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
