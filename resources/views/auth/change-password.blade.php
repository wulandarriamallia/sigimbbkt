    ...
    <div class="col-md-6">
      <div class="card mx-4">
        <div class="card-body p-4">
          {!! Form::model($user, ['route' => ['auth.post-change-password'], 'method' => 'PUT', 'class' => 'form-horizontal', 'role' => 'form', 'id' => 'change-form']) !!}
            <h1>@yield('title')</h1>
            ...
            <div class="text-center">Kembali ke halaman <a href="{!! route('auth.profile') !!}">Profil</a></div>
          {!! Form::close() !!}
        </div>
      </div>
    </div>
