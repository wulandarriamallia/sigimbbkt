  ...
  <div class="row">
    ...
    <div class="col-sm-6 col-lg-3">
      <div class="card text-white bg-primary">
        ...
        <div class="px-3" style="height:50px;">
          <a href="{!! route('adm::imbPemohon.index') !!}" class="btn btn-outline-dark pull-right"><i class="fa fa-sign-in"></i>&nbsp; Lihat</a>
        </div>
      </div>
    </div>
    <!--/.col-->
    ...
    <div class="col-sm-6 col-lg-3">
      <div class="card text-white bg-danger">
        ...
        <div class="px-3" style="height:50px;">
          <a href="{!! route('adm::user.index') !!}" class="btn btn-outline-dark pull-right"><i class="fa fa-sign-in"></i>&nbsp; Lihat</a>
        </div>
      </div>
    </div>
    <!--/.col-->
