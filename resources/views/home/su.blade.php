  ...
  <div class="row">
    <div class="col-sm-6 col-lg-3">
      <div class="card text-white bg-primary">
        ...
        <div class="px-3" style="height:50px;">
          <a href="{!! action('ImbPemohonController@index') !!}" class="btn btn-outline-dark pull-right"><i class="fa fa-sign-in"></i>&nbsp; Lihat</a>
        </div>
      </div>
    </div>
    <!--/.col-->
    ...
    <div class="col-sm-6 col-lg-3">
      <div class="card text-white bg-success">
        ...
        <div class="px-3" style="height:50px;">
          <a href="{!! action('ImbController@index') !!}" class="btn btn-outline-dark pull-right"><i class="fa fa-sign-in"></i>&nbsp; Lihat</a>
        </div>
      </div>
    </div>
    <!--/.col-->
    ...
    <div class="col-sm-6 col-lg-3">
      <div class="card text-white bg-warning">
        ...
        <div class="px-3" style="height:50px;">
          <a href="{!! action('ImbSpasialController@index') !!}" class="btn btn-outline-dark pull-right"><i class="fa fa-sign-in"></i>&nbsp; Lihat</a>
        </div>
      </div>
    </div>
    <!--/.col-->
    ...
    <div class="col-sm-6 col-lg-3">
      <div class="card text-white bg-danger">
        ...
        <div class="px-3" style="height:50px;">
          <a href="{!! action('UserController@index') !!}" class="btn btn-outline-dark pull-right"><i class="fa fa-sign-in"></i>&nbsp; Lihat</a>
        </div>
      </div>
    </div>
    <!--/.col-->
            ...
            <div class="col-sm-12 col-lg-6">
              <ul class="horizontal-bars type-2">
                ...
                <li>
                  ...
                  <span class="title">Sistem Operasi</span>
