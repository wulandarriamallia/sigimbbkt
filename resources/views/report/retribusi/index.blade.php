  ...
  <div class="col-sm-12">
    <div class="card card-accent-primary">
      ...
      <div class="card-body text-dark p-0">
        {{ Form::open(['route' => 'front_office::report.post-retribusi', 'class' => 'form-horizontal', 'role' => 'form']) }}
        <div class="card-body">
            ...
            <div class="col-md-9">
              <select class="form-control select2" name="retribusi_id" id="retribusi_id">
                ...
                @foreach ($imbRetribusis as $imbRetribusi)
                  <option value="{!! $imbRetribusi->id !!}">{!! \sigimbbkt\Libraries\IdConversion::conversionException(\sigimbbkt\Libraries\IdConversion::getImbPemohonAll($imbRetribusi->imb->imb_pemohon_id), 'nama') . ' - ' . $imbRetribusi->guna_bangunan . '/' . $imbRetribusi->jenis_bangunan !!}</option>
                @endforeach
              </select>
            </div>
